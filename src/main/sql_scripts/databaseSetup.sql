...
(
    Division_Name VARCHAR2 (20) PRIMARY KEY,
...
(
    HomeTeamName VARCHAR2 (20),
    HomeTeamCity VARCHAR2 (20),
    AwayTeamName VARCHAR2 (20),
    AwayTeamCity VARCHAR2 (20),
    Date         DATE,
    Venue        VARCHAR2 (20),
...
INSERT INTO Team VALUES ('Oklahoma City Thunder', 123123123, 'Paycom Center', 'Oklahoma City', 'Northwest');
...
INSERT INTO Signed_Contract VALUES (50000, 1, 5, 1000000, '2023-10-20', 1);
INSERT INTO Signed_Contract VALUES (60000, 2, 4, 800000, '2023-10-21', 2);
INSERT INTO Signed_Contract VALUES (70000, 3, 6, 1200000, '2023-10-22', 3);
INSERT INTO Signed_Contract VALUES (55000, 4, 3, 700000, '2023-10-23', 4);
INSERT INTO Signed_Contract VALUES (65000, 5, 7, 1500000, '2023-10-24', 5);

-- Player_Plays_For_Team table
INSERT INTO Player_Plays_For_Team VALUES ('2018-06-21', '1999-02-28', 201, 'Luka Doncic', 77, 2473875, 'Mavericks', 'Dallas');
INSERT INTO Player_Plays_For_Team VALUES ('2015-06-25', '1993-03-14', 203, 'Stephen Curry', 30, 1729634, 'Warriors', 'Golden State');
INSERT INTO Player_Plays_For_Team VALUES ('2014-06-26', '1988-12-30', 206, 'LeBron James', 23, 1248756, 'Lakers', 'Los Angeles');
INSERT INTO Player_Plays_For_Team VALUES ('2013-06-27', '1989-03-29', 201, 'Anthony Davis', 3, 1342351, 'Lakers', 'Los Angeles');
INSERT INTO Player_Plays_For_Team VALUES ('2016-06-23', '1994-03-16', 193, 'Giannis Antetokounmpo', 34, 1534897, 'Bucks', 'Milwaukee');
